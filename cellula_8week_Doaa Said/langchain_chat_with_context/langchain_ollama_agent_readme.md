# 🧠 LangChain Ollama Context-Aware Agent
...
│
├─ Agent/
│   └─ agent_runner.py          # Function to build agent with LLM and tools
│
├─ tools/
...
│   └─ web_search_tool.py
│
├─ ui.py                        # Main Gradio interface script
├─ README.md
└─ requirements.txt
```
...
4. **Run a local Ollama model server** (if using Ollama locally)
